...
namespace App.Migrations
{
    ...
    [Migration("20240713202641_propertyDbSetsAdd")]
    partial class propertyDbSetsAdd
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Models.Address", b =>
                {
                    b.HasOne("App.Models.AppUser", "User")
                        .WithOne()
                        .HasForeignKey("App.Models.Address", "UserId")
            ...
            modelBuilder.Entity("App.Models.Comment", b =>
                {
                    ...
                    b.HasOne("App.Models.AppUser", "WrittenBy")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("App.Models.Post", b =>
                {
                    b.HasOne("App.Models.AppUser", "Createdby")
                        .WithMany("Posts")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("App.Models.UserRole", null)
                        .WithMany()
